...
import ExperimentPageView, { ExperimentView } from 'src/components/explat/experiments/single-view/ExperimentPageView'
...
export default function Experiment(): JSX.Element | null {
  const { experimentIdSlug, view: viewRaw } = useParams<{
